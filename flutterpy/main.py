...
parser.add_argument('--major', '-m', action='store_true', help='bump flutter app to next major version (default: False)')
parser.add_argument('--minor', '-n', action='store_true', help='bump flutter app to next minor version (default: False)')
parser.add_argument('--patch', '-p', action='store_true', help='bump flutter app to next patch version (default: False)')
